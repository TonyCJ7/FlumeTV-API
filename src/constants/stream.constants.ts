...
export const ID_PREFIX = process.env.ID_PREFIX || "flumetv_";
...
/** Xtream live playback suffix when sync row and panel omit container_extension. */
export const LIVE_CONTAINER_EXTENSION_FALLBACK = "ts";
